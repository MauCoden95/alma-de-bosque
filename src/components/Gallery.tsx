...
export default function Gallery() {
  ...
  const categories = [
    ...
    { label: "Snow Season", value: "Snow Season" },
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="text-zinc-400 font-sans text-sm md:text-base">
            Explore postcards of our serene woodland cabins, custom cozy lounges, frozen winters, and scenic summer trails in Bariloche.
          </p>
